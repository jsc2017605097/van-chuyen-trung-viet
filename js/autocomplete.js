    ...
    r.utils = e, t.Autocomplete = r, r.defaults = {
        ...
        initialize: function () {
            ...
            if (this.suggestions.length) {
                let dataX = this.suggestions[0];
                document.getElementById('search_data').value = dataX.data
                document.getElementById('search_value').value = dataX.value
                ...
                s.triggerSelectOnValidInput && this.isExactMatch(o) ? this.select(0) : (t.each(this.suggestions, function (t, u) {
                    ...
                    }(u, 0)), c += '<div class="' + a + '" data-index="' + t + '" data-value="' +u.data+ '">' + n(u, o, t) + "</div>"
